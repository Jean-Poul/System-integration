 ...
 */
    ...
    public dk.si.ipsoap.GeoIPServiceSoap_PortType getGeoIPServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public dk.si.ipsoap.GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dk.si.ipsoap.GeoIPServiceSoap_BindingStub _stub = new dk.si.ipsoap.GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public dk.si.ipsoap.GeoIPServiceSoap_PortType getGeoIPServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public dk.si.ipsoap.GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dk.si.ipsoap.GeoIPServiceSoap12Stub _stub = new dk.si.ipsoap.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dk.si.ipsoap.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dk.si.ipsoap.GeoIPServiceSoap_BindingStub _stub = new dk.si.ipsoap.GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (dk.si.ipsoap.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dk.si.ipsoap.GeoIPServiceSoap12Stub _stub = new dk.si.ipsoap.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
