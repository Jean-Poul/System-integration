 ...
 */
    ...
    public GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            GeoIPServiceSoap_BindingStub _stub = new GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            GeoIPServiceSoap12Stub _stub = new GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                GeoIPServiceSoap_BindingStub _stub = new GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                GeoIPServiceSoap12Stub _stub = new GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
